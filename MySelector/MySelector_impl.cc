...
selector::make(size_t itemsize, unsigned int input_index, unsigned int output_index)
{
    return gnuradio::make_block_sptr<MySelector_impl>(itemsize, input_index, output_index);
}

MySelector_impl::MySelector_impl(size_t itemsize,
...
MySelector_impl::~MySelector_impl() {}

void MySelector_impl::set_input_index(unsigned int input_index)
{
...
void MySelector_impl::set_output_index(unsigned int output_index)
{
    gr::thread::scoped_lock l(d_mutex);
...
void MySelector_impl::handle_msg_input_index(pmt::pmt_t msg)
{
...
void MySelector_impl::handle_msg_output_index(pmt::pmt_t msg)
{
    pmt::pmt_t data = pmt::cdr(msg);
...
void MySelector_impl::handle_enable(pmt::pmt_t msg)
{
    if (pmt::is_bool(msg)) {
...
void MySelector_impl::forecast(int noutput_items, gr_vector_int& ninput_items_required)
{
...
bool MySelector_impl::check_topology(int ninputs, int noutputs)
{
...
int MySelector_impl::general_work(int noutput_items,
...
void MySelector_impl::setup_rpc()
{
#ifdef GR_CTRLPORT
